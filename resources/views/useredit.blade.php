                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('updateUser') }}/{{$user->id}}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="gender" class="form-control" id="gender" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('contact_no') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Contect No</label>

                            <div class="col-md-6">
                                <input id="contact_no" type="number" class="form-control" name="contact_no" value="{{ old('contact_no',$user->contact_no) }}" required autofocus>
